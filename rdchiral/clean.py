...
def combine_enantiomers_into_racemic(
    ...
    Returns:
        Tuple[Set[str], Dict[str, str]]:
            - First element: The updated set of SMILES outcomes with certain enantiomeric/cis-trans
              duplicates collapsed.
            - Second element: A dictionary mapping replaced stereoisomeric SMILES to the
              racemic/achiral SMILES that replaced them.
    ...
    for smiles in list(final_outcomes):
        ...
        for match in re.finditer(r"@@", smiles):
            ...
            if smiles_inv in final_outcomes:
                ...
                replaced_map[original_smiles] = smiles
                replaced_map[smiles_inv] = smiles
        ...
        for match in chain(
            ...
            if remove:
                ...
                smiles = ".".join(sorted(Chem.MolToSmiles(outcome, True).split(".")))
                final_outcomes.add(smiles)
                for cis_smiles in removed_cis:
                    replaced_map[cis_smiles] = smiles
                replaced_map[original_smiles] = smiles
    return final_outcomes, replaced_map
